...
def transform_user_data(raw: pd.DataFrame, filename: str = "Unknown") -> pd.DataFrame:
    ...
    # Force correct detection for your default sample data
    ...
    if "titanic" in filename.lower() or "survived" in df.columns or not is_business_like:
        df.attrs['dataset_type'] = "non_business"
        # Try to use 'fare' as revenue for Titanic
