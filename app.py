...
# ====================== LOAD & RUN PIPELINE (Force refresh on upload) ======================
if uploaded:
...
# CEO Assistant Tab (Casual greeting support)
with tab_ai:
    st.subheader("🤖 CEO Assistant — Groq LLaMA-3 70B")

    SYS_PROMPT = f"""You are a friendly and professional CEO's personal AI assistant.
...
Rules:
- If user says 'hi', 'hello', 'how are you' or casual greeting → respond casually and friendly.
- If user asks business or dataset questions → use the metrics and be helpful.
- Be natural and concise."""

    if "chat" not in st.session_state:
        st.session_state.chat = [{"role": "assistant", "content": "👋 Hello! How can I help you today?"}]
